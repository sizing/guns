...
public class ConstantFactory implements IConstantFactory {
    ...
    private FzMapper FzMapper = SpringContextHolder.getBean(FzMapper.class);
    ...
    @Override
    public List<Fz> findInFz(Long id) {
        if (ToolUtil.isEmpty(id)) {
            return null;
        } else {
            EntityWrapper<Fz> wrapper = new EntityWrapper<>();
            List<Fz> fzs = FzMapper.selectList(wrapper.eq("ID_FZ", id));
            System.out.println(fzs);
