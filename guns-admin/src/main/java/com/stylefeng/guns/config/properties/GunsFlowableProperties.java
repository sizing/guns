...
public class GunsFlowableProperties {
     ...
     * 默认多数据源的链接
     */
    private String url = "jdbc:mysql://localhost:3306/guns_flowable?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
     ...
     * 默认多数据源的数据库密码
     */
    private String password = "l12345";
